...
class Bola:
    def __init__(self, r): # edit double garis bawah
        self.r = r
...
## fungsi ini terpisah dari class Bola
def clear_screen():
    if os.name=='posix':
       os.system("clear")
    if os.name=='nt':
...
def main():
    diameter = float(input("Masukkan Diameter Bola: ")) # edit # to float
...
if __name__ == "__main__": ##edit double gaaris bawah
        main()
